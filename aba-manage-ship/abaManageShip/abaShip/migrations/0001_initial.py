    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NOTYETSHIPPED', 'not yet shipped'), ('SHIPPING', 'shipping'), ('SHIPPED', 'shipped')], default=abaShip.models.StatusShip['NOTYETSHIPPED'], max_length=30)),
            ],
            options={
                'abstract': False,
            },
